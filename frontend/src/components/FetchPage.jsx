...
import { Search, RefreshCw, AlertCircle, Building2, User, Scale, Download, ArrowLeft } from 'lucide-react';
import '../App.css';
  ...
  return (
    <div className="container">
      <header className="app-header" style={{ position: 'relative' }}>
        <Link to="/" className="btn-secondary" style={{ position: 'absolute', left: 0, top: '0.5rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 1rem', fontSize: '0.875rem' }}>
          <ArrowLeft size={16} /> Back to Dashboard
        </Link>
        <h1 className="app-title" style={{ marginTop: '2.5rem' }}>eCourts Extractor</h1>
